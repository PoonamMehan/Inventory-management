  ...
  return (
    <Box width="100vw" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center" gap={2}>
      <Modal open={open} onClose={handleClose}>
        <Box position="absolute" top="50%" left="50%" width={400} bgcolor="white" border="2px solid black" boxShadow={24} display="flex" flexDirection="column" gap={3} sx={{transform: "translate(-50%, -50%)"}} padding={3}>
      ...
      <Box border="1px solid #333">
        <Box width = "800px" height="100px" backgroundColor="#ADD8E6" display="flex" alignItems="center" justifyContent="center">
